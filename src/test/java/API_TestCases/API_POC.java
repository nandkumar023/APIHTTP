...
import com.API.Utilities.FilloExcellReader;
...
public class API_POC extends BaseTest {
	...
	public void a_get_accessToken() throws Exception {
		try {
			...
			com.API.Base.BaseTest.PASSED_TC_COUNTER = com.API.Base.BaseTest.PASSED_TC_COUNTER + 1;
		} catch (Exception e) {
	...
	public void b_accessTokenInfo() throws Exception {
		try {
			LinkedHashMap<String, String> data = new FilloExcellReader().getTestDataFromExcellSheet("Sheet1", "10", "1",
					"1");
			...
			Response response = util.requestWithHeaderAndParameter(2, header, querryParam, EnumHelper.HTTP_Method.GET,
	...
	public void c_checkIfUserExists() throws Exception {
		try {
//			if(!acc_Token.isEmpty())
//				throw new SkipException("Skipping test case C");
			LinkedHashMap<String, String> header = new LinkedHashMap<String, String>();
